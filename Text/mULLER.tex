...
\end{tabular}
\end{table}
\ednote{ \textbf{sLXz}: "This is particularly problematic with the notation and the main results presented on page 6 and Table 2. Please explain the notation to the non-expert. What is T and F?"}
