...
def sample(value: GiryMonadPyMC) -> float:
    ...
    return value.sample(10000).mean()
...
class TestGiryMonad(unittest.TestCase):
    ...
    def test_bind_operation(self):
        ...
        bound = monad.bind(lambda x: constant(x * 3))
    ...
    def test_monad_laws(self):
        ...
        m = constant(7)
        bound = m.bind(GiryMonadPyMC.unit)
    ...
    def test_complex_composition(self):
        ...
        result = (
            initial.bind(lambda x: constant(x + 1))  # 1 -> 2
