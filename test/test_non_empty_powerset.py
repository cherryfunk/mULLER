...
class TestNonEmptyPowersetMonad(unittest.TestCase):
    ...
    def assertNonEmptyPowersetEqual(self, ps1: NonEmptyPowerset, ps2: NonEmptyPowerset, msg=None):
    ...
    def test_monad_laws(self):
        ...
        a = 5
        f = lambda x: NonEmptyPowerset([x, x + 1])
        ...
        g = lambda x: NonEmptyPowerset([x * 2, x * 3])
    ...
    def test_search_space_exploration(self):
        ...
        expected = NonEmptyPowerset(['position_1', 'position_2', 'position_3', 
    ...
    def test_choice_explosion(self):
        ...
        step1 = initial.bind(lambda x: NonEmptyPowerset([x*10, x*10+1, x*10+2]))
